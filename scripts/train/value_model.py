...
class Args:
    ...
    resume_from_training_step: Optional[int] = None
...
def main(args: Args, dataset_config: DatasetConfig, model_config: ModelConfig):
    ...
    dataset_processor = ValueModelDatasetProcessor(tokenizer=tokenizer, config=dataset_config)
    ...
    for epoch_id in range(args.num_train_epochs):
        for data in tqdm(dataloader):
            ...
            if args.resume_from_training_step is not None and training_step < args.resume_from_training_step:
                continue
