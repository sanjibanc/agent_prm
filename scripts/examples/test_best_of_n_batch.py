...
agent = BestofNAgent(generator=generator, critic=critic, num_generations=num_responses, verbose=1)
...
reason_actions_all_queries = agent.predict_reason_action_batch(queries, num_responses=1)
end_time = time.time()
